...
function the_champ_sanitize_profile_data($profileData, $provider){
	...
	if($provider == 'facebook'){
		...
		if(isset($tempProfileData->email_verified) && $tempProfileData->email_verified == 'true' && isset($profileData->email)){
			$temp['email'] = sanitize_email($profileData->email);
		}elseif(isset($tempProfileData->email_verified) && $tempProfileData->email_verified != 'true'){
			$temp['email'] = '';
		}elseif(!isset($tempProfileData->email_verified) && isset($tempProfileData->email)){
			$temp['email'] = sanitize_email($profileData->email);
		}
